...
CREATE TABLE `Folders_Users`(
    ...
    `flashcard_folder_id` BIGINT NOT NULL,
...
ALTER TABLE
    `table_15` ADD CONSTRAINT `table_15_customer_id_foreign` FOREIGN KEY(`customer_id`) REFERENCES `Customers`(`id`);
ALTER TABLE
...
ALTER TABLE
    `table_15` ADD CONSTRAINT `table_15_authority_id_foreign` FOREIGN KEY(`authority_id`) REFERENCES `Authorities`(`id`);
ALTER TABLE
    `Decks` ADD CONSTRAINT `decks_folder_foreign` FOREIGN KEY(`folder`) REFERENCES `Folders_Decks`(`Deck_id`);
ALTER TABLE
